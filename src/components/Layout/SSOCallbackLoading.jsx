const SSOCallbackLoading = () => {
  return (
    ...
    >
      <div className="flex w-[min(340px,calc(100vw-2rem))] flex-col items-center justify-center gap-5 rounded-3xl border border-violet-400/20 bg-white/80 px-9 py-8 text-center shadow-[0_18px_45px_rgba(15,23,42,0.08)] backdrop-blur-xl dark:border-gray-800 dark:bg-gray-900/80">
        <div
        ...
        <div className="space-y-1">
          <h2 className="text-[1.05rem] font-bold tracking-[-0.02em] text-slate-800 dark:text-gray-100">
            Signing you in
          </h2>

          <p className="text-[0.95rem] text-slate-500 dark:text-gray-400">
...
export default SSOCallbackLoading;
